<x-app-layout>
    <x-slot name="header">
        <h1 class="text-2xl font-bold text-gray-900">Create New Room</h1>
    </x-slot>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <form action="{{ route('admin.rooms.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6" x-data="roomForm()">
            @csrf
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="rate_per_night" id="rate_per_night" value="{{ old('rate_per_night') }}"
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="bed_count" id="bed_count" value="{{ old('bed_count', 1) }}" min="1" required
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="sleeps" id="sleeps" value="{{ old('sleeps', 2) }}" min="1" required
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('roomForm', () => {
                const initAmenities = {!! json_encode(old('amenities', [''])) !!};
