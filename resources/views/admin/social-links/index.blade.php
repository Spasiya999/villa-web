<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h1 class="text-2xl font-bold text-gray-900">Social Media Links</h1>
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    @forelse($socialLinks as $link)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-semibold text-gray-900">{{ $link->platform }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-600 max-w-xs truncate">{{ $link->url }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                                    class="px-2 py-1 text-xs font-semibold rounded-full {{ $link->is_active ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700' }}">
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-10 text-center text-gray-500">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-lg font-medium text-gray-600">No social links added yet</p>
                                    <p class="text-sm text-gray-400 mt-1">Get started by creating your first social media
                                        link.</p>
                                </div>
                            </td>
                        </tr>
