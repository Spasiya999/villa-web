<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
            <form action="{{ route('admin.social-links.update', $social_link) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="platform" id="platform"
                            value="{{ old('platform', $social_link->platform) }}" placeholder="e.g. Facebook" required
                        ...
                        <select name="icon" id="icon" required
                            ...
                            @php
                                $icons = [
                                    ...
                                    'linkedin' => 'LinkedIn',
                                    'github' => 'GitHub',
                                    'message-circle' => 'WhatsApp / Message',
                                    'mail' => 'Email',
                                    'phone' => 'Phone',
                                    'globe' => 'Website',
                                ];
                            ...
                            @foreach($icons as $val => $label)
                                <option value="{{ $val }}" {{ old('icon', $social_link->icon) == $val ? 'selected' : '' }}>
                                    {{ $label }}</option>
                            @endforeach
                        </select>
                ...
                <div>
                    ...
                    <input type="url" name="url" id="url" value="{{ old('url', $social_link->url) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="sort_order" id="sort_order"
                            value="{{ old('sort_order', $social_link->sort_order) }}" required
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    ...
                    <div>
                        ...
                        <div class="flex items-center mt-3">
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="is_active" value="1" {{ old('is_active', $social_link->is_active) ? 'checked' : '' }} class="sr-only peer">
                                <div
