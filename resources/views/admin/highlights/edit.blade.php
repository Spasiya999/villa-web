                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="label" id="label"
                            value="{{ old('label', $highlight->label) }}" placeholder="e.g., 4 Bedrooms" required
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="sublabel" id="sublabel"
                            value="{{ old('sublabel', $highlight->sublabel) }}" placeholder="e.g., Sleeps 8"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="order" id="order"
                            value="{{ old('order', $highlight->order) }}" min="0" required
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    ...
                    <div class="flex items-center justify-between pt-4 border-t border-gray-200">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="is_active" value="1"
                                {{ old('is_active', $highlight->is_active) ? 'checked' : '' }} class="sr-only peer">
                            <div
