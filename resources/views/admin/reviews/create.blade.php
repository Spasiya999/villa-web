    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Add a new guest review to display on the webpage.</p>
            </div>
    ...
    <div class="max-w-4xl mx-auto py-6">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <form action="{{ route('admin.reviews.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <!-- Name -->
                <div>
                    <label for="name" class="block text-sm font-medium text-gray-700 mb-2">Guest Name <span
                ...
                <!-- Rating -->
                <div>
                    <label for="rating" class="block text-sm font-medium text-gray-700 mb-2">Rating <span
                            class="text-red-500">*</span></label>
                ...
                <!-- Review Text -->
                <div>
                    <label for="review" class="block text-sm font-medium text-gray-700 mb-2">Review Content <span
                            class="text-red-500">*</span></label>
                    <textarea name="review" id="review" rows="4" required
                        class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 transition-colors">{{ old('review') }}</textarea>
                    @error('review')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                    ...
                    <div class="flex items-start space-x-6">
                        <div class="flex-1">
                            <div class="flex items-center justify-center w-full">
                                <label for="image"
                                    class="flex flex-col items-center justify-center w-full h-40 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
                                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                        ...
                                        <p class="mb-2 text-sm text-gray-600"><span
                                                class="font-semibold text-blue-600">Click to upload</span> or drag and
                                            drop</p>
                        ...
                        <div id="imagePreviewContainer" class="hidden shrink-0">
                            ...
                            <div
                                class="relative w-32 h-32 rounded-full overflow-hidden border border-gray-200 bg-gray-50 shadow-sm">
