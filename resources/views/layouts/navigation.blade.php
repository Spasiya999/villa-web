        ...
        <aside
            ...
            <div class="flex items-center justify-between h-16 px-6 bg-slate-900/50">
                <a href="{{ route('dashboard') }}" class="flex items-center space-x-3">
                    ...
                    <span class="text-xl font-bold text-white">Villa Admin</span>
                </a>
            ...
            <nav class="px-4 py-6 space-y-2 overflow-y-auto h-[calc(100vh-4rem)]">
                ...
                <!-- Gallery -->
                <a href=""
                    class="flex items-center px-4 py-3 text-gray-300 hover:bg-slate-700/50 hover:text-white rounded-lg transition-all duration-200 {{ request()->routeIs('admin.gallery.*') ? 'bg-slate-700 text-white' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
